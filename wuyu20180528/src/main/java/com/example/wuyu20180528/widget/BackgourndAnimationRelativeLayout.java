package com.example.wuyu20180528.widget;
...
import com.example.wuyu20180528.R;
...
public class BackgourndAnimationRelativeLayout extends RelativeLayout {
    ...
    private void initLayerDrawable() {
        Drawable backgroundDrawable = ContextCompat.getDrawable(getContext().getApplicationContext(), R.drawable.ic_blackground);
